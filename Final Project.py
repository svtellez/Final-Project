...
# the format command always us to concatenate parts of a string
...
# the sep= "" makes sure that the $ and the number don't have a space in between
...
# you decide to split the amount you owe in card between two cards
...
print(2 ** 3)
# the % is called a modulo, and it is used to get the remainder of the division
print(22 % 3)
# Sprint 2 Begins Here
# The AND boolean is true if both are true
# if is used to determine the conditions
...
# The OR boolean is true if at least one if true
# if-else is used to determine the conditions
...
# The NOT boolean is true if it does not meet the condition
# If is used to determine the condition
first_num = 3
second_num = 5
...
# While loops are used to repeat code for an undetermined number of times
# you can set conditions for when you want it to stop
# != means not equal
first_num = 10
while first_num != 0:
...
# you can determine the number of times it will repeat
first_num = 0
for x in range(5):
...
def age(total_age="20"):
    print("I am " + total_age, "years old!")


age("17")

# this next part shows how a while loop can repeat itself
# the while loop will repeat until the user inputs the correct number
# once the user inputs the correct number the loop will stop

while True:
    try:
        christmas_date = int(input("When is Christmas?"))
    except ValueError:
        print("Wrong!")
        continue
    if christmas_date == 25:
        print("Correct!")
        break
    else:
        print("Try Again!")
